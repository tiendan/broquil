...
urlpatterns = [
    ...
    url(_(r'^dist/pdf/$'), broquil_views.download_orders_pdf,
        name='download_orders_pdf'),
    url(_(r'^dist/cash/$'), broquil_views.count_initial_cash,
        name='count_initial_cash'),
    url(_(r'^dist/baskets/$'), broquil_views.view_basket_counts,
        name='view_basket_counts'),
    url(_(r'^dist/([0-9]+)/$'), broquil_views.view_product_orders,
        name='view_product_orders'),
    url(_(r'^dist/product/([0-9]+)/$'),
        broquil_views.view_product_orders_with_id,
        name='view_product_orders_with_id'),
    url(_(r'^dist/payment/$'),
        broquil_views.member_payment,
        name='member_payment'),
    url(_(r'^dist/account/$'),
    ...
    url(_(r'^products/view/(?P<producer_id>[0-9]+)$'),
        broquil_views.view_products,
        name='view_products'),
    url(_(r'^products/view/$'),
        broquil_views.view_products,
        name='view_products'),
    url(_(r'^products/confirm/$'),
        broquil_views.confirm_products,
        name='confirm_products'),
    url(_(r'^products/check/$'),
        broquil_views.check_products,
        name='check_products'),
    url(_(r'^products/upload/$'),
    ...
    url(_(r'^producer/$'),
        ...
        name='producer_info'),
    url(_(r'^producer/(?P<producer_id>[0-9]+)$'),
        broquil_views.producer_info,
        name='producer_info'),
    ...
    url(r'^accounts/passwordchange/$', auth_views.password_change,
        {'post_change_redirect': '/'}),
    url(r'^accounts/passwordreset/$', auth_views.password_reset,
        {'post_reset_redirect': '/'}),
    url(r'^accounts/passwordresetconfirm/(?P<uidb64>.+)/(?P<token>.+)/$',
        auth_views.password_reset_confirm, {'post_reset_redirect': '/'}),
